...
namespace RuntimeNodeEditor
{
    public class NodeEditor : MonoBehaviour
    {
        ...
        public SignalSystem Events
        {
            get { return _signalSystem; }
        }
        ...
        public TGraphComponent CreateGraph<TGraphComponent>(RectTransform holder, NodeGraphSettings settings)
            where TGraphComponent : NodeGraph
        {
            //  Create a parent
            ...
            bg.AddComponent<Image>().color = settings.bgColor;
            ...
            graphRect.localScale = Vector3.one;
            graphRect.sizeDelta = settings.graphSize;
            ...
            bezierDrawer.connectionColor = settings.connectionColor;
